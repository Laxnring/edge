...
final class FlutterBluePlusWeb extends FlutterBluePlusPlatform {
  ...
  Future<bool> setNotifyValue(
    ...
    // Web Bluetooth configures notifications directly through
    // `startNotifications` / `stopNotifications`. Unlike native platforms,
    // it cannot emit a later CCCD descriptor-write callback. Returning true
    // would make the shared flutter_blue_plus wrapper wait for that nonexistent
    // callback even though the browser has already enabled the data channel.
    return false;
  }
